...
export class DataGenerator {
    /**
     * Constructs a new `DataGenerator`
     ...
     * @param options An object describing how replace the values as: `{ "pattern" : (generator) => value, ... }`.
     * 
     * @example
     * ```
     * const generator = new DataGenerator();
     * 
     * // Here we replace all the `x` charactes with the number returned by `gen.nextInt(0, 10)`
     * const number = generator.nextPattern("1-xxx-xxxx", {
     *      "x" : (gen) => gen.nextInt(0, 10)
     * })
     * ```
     */
     ...
     * @param {(DataGenerator, Number) => any} factory Constructs the objects of the array.
     * 
     * @example
     * ```
     * // Constructs an array of 5 persons which contains a name, lastName and age
     * const persons = new DataGenerator().newArray(5, (gen) => {
     *      return {
     *          name: gen.nextName(),
     *          lastName: gen.lastName(),
     *          age: gen.nextInt(1, 100)
     *      };
     * });
     * ```
     */
...
/**
 * A global instance of the `DataGenerator`.
 */
